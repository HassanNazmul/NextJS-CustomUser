...
import {loginUser} from "@/components/loginX/LoginAPI";
    ...
    const handleSubmit = async (): Promise<void> => {
        if (email && password) {
            ...
            try {
                ...
                // No need to check response.ok, handle successful loginX directly
                ...
                <div className="w-full flex-grow flex flex-col justify-center">
                    ...
                    <div className="w-full flex space-x-4 pt-12 pb-4">
                        <button
                            ...
                            aria-label={submitted ? "Login submitted" : "Submit loginX"}
                        >
                            {isLoading ? (
                                <>
